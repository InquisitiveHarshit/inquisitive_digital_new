                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8 pt-8 pb-12 md:pb-20">
                    <div className="grid lg:grid-cols-3 gap-10 md:gap-16">
                        ...
                        >
                            ...
                            <div className={`font-body text-base md:text-lg leading-loose prose max-w-none ${isLight ? "prose-slate" : "prose-invert prose-p:text-slate-300 prose-headings:text-white prose-a:text-brand-accent prose-li:text-slate-300"
