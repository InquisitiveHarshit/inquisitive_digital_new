...
export default function ServiceDetailClient({ initialService }: { initialService: ServiceData | null }) {
  const router = useRouter();
  const service = initialService;

  useEffect(() => {
    // Scroll to top to avoid browser scroll restoration issues on dynamic routes
