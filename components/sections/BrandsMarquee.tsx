...
export const BrandsMarquee: React.FC = () => {
  ...
  return (
    <section className={`py-16  border-b overflow-hidden relative ${themeMode === "singular-dark" ? "bg-[#0a0a0a] border-white/10" : themeMode === "singular-light" ? "bg-[#111111] border-white/5" : "bg-[#111111] border-white/5"}`}>
      ...
      <div className="relative w-full overflow-hidden flex">
        ...
        <div className={`absolute top-0 left-0 w-24 sm:w-40 h-full z-10 pointer-events-none ${themeMode === "singular-dark" ? "bg-gradient-to-r from-[#0a0a0a] to-transparent" : themeMode === "singular-light" ? "bg-gradient-to-r from-[#111111] " : "bg-gradient-to-r from-[#111111] to-transparent"}`}></div>
        <div className={`absolute top-0 right-0 w-24 sm:w-40 h-full z-10 pointer-events-none ${themeMode === "singular-dark" ? "bg-gradient-to-l from-[#0a0a0a] to-transparent" : themeMode === "singular-light" ? "bg-gradient-to-l from-[#111111] " : "bg-gradient-to-l from-[#111111] to-transparent"}`}></div>
